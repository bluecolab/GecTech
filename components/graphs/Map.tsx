...
export default function Map({ center = [-74.006, 40.7128], zoom = 10, height = 300, markers = [], isDark = false }: MapProps) {
      ...
      .then((mod) => {
        ...
        markers.forEach((m) => {
          try {
            ...
            const marker = new maplibre.Marker(el).setLngLat(m.coordinates).addTo(mapRef.current)
